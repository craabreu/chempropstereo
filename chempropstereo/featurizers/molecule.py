...
from . import utils
from .atom import AtomAchiralFeaturizer
...
class MoleculeStereoFeaturizer(chemprop.featurizers.SimpleMoleculeMolGraphFeaturizer):
    ...
    Vertices:
      ...
      3: 0010000000000 0001000 000010 010000 00100 0 0.120
      4: 0010000000000 0001000 000010 100000 00100 0 0.120
    ...
    Edges:
        ...
        0→1: 0 1000 0 0 0010 00 00
        2→1: 0 1000 0 0 1000 00 00
        1→2: 0 1000 0 0 0000 00 00
        3→1: 0 1000 0 0 0100 00 00
...
class MoleculeNeighborRankingFeaturizer(
    chemprop.featurizers.SimpleMoleculeMolGraphFeaturizer
):
    r"""Multi-hot molecule featurizer that includes neighbor ranking information.

    Parameters
    ----------
    divergent_bonds : bool
        Whether to add neighbor information to the directed bonds that diverge from
        a central atom, as opposed to those that converge to it.
    ...
    def pretty_print(self, mol: Chem.Mol) -> None:
        ...
        -------
        >>> from rdkit import Chem
        >>> from chempropstereo import MoleculeNeighborRankingFeaturizer
        >>> mol = Chem.MolFromSmiles("C[C@H](N)O")
        >>> featurizer = MoleculeNeighborRankingFeaturizer(
        ...     mode="ORGANIC", divergent_bonds=True
        ... )
        >>> print(featurizer.pretty_print(mol))  # doctest: +NORMALIZE_WHITESPACE
        Vertices:
          0: 0010000000000 0000100 000010 000100 00010 0 0.120
